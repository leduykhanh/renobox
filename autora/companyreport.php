...
?>
 ...
 <div id="risk_register" style="width:100%;margin-top:40px">
    ...
    <table id="risk_register_2" style="width:100%;">
        <tr >
                    <td rowspan="1" colspan="4" style="width:75%"><b>Department:Reno Box Pte Ltd</b></td>
     ...
     <h1>Risk Assessment Form </h1>
        ...
        ?>
            ...
            <tr >
                    ...
                    <td rowspan="6" colspan="1" style="width:10%;vertical-align: middle;"><img width='100' src='staff/stamp.png' /><br />Reference Number<h1>P-0<?php echo $risk['id']; echo $risk['id'];??></h1></td>
